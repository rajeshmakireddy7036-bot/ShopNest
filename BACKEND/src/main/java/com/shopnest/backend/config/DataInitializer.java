        ...
        private void seedAdmin() {
                ...
                if (userRepository.findByEmail("admin@shopnest.com").isEmpty()) {
                        User admin = User.builder()
                                        ...
                                        .password(passwordEncoder.encode("admin1234")) // Hashed password
                                        .role("ROLE_ADMIN")
                                        .build();
        ...
        private void seedProducts() {
                if (productRepository.count() == 0) {
                        List<Product> initialProducts = Arrays.asList(
                                        // Men
                                        new Product(null, "Classic Oxford Shirt",
                                                        "Timeless white oxford shirt for a sharp look.", 59.99,
                                                        ...
                                                        null, 50),
                                        new Product(null, "Slim Fit Chinos",
                                                        "Comfortable and stylish chinos for any occasion.", 49.99,
                                                        ...
                                                        null, 40),
                                        new Product(null, "Heavyweight Hoodie",
                                                        "Premium cotton hoodie for maximum warmth.", 79.99, "Men",
                                                        "Hoodies", "Men", Arrays.asList("M", "L", "XL"),
                                                        "https://images.unsplash.com/photo-1556821840-3a63f95609a7?q=80&w=1000&auto=format&fit=crop",
                                                        null, 30),

                                        // Women
                                        new Product(null, "Floral Maxi Dress",
                                                        "Elegant flowy dress perfect for spring gardens.", 89.99,
                                                        ...
                                                        null, 25),
                                        new Product(null, "Silk Blouse",
                                                        "Luxurious silk blouse for the modern professional.", 120.00,
                                                        ...
                                                        null, 15),
                                        new Product(null, "High-Waisted Jeans",
                                                        "Classic denim that complements every silhouette.", 75.00,
                                                        "Women", "Bottoms", "Women",
                                                        Arrays.asList("24", "26", "28", "30"),
                                                        "https://images.unsplash.com/photo-1541099649105-f69ad21f3246?q=80&w=1000&auto=format&fit=crop",
                                                        null, 35),

                                        // Accessories
                                        new Product(null, "Gold Minimalist Ring",
                                                        "14k gold plated ring for everyday elegance.", 45.00,
                                                        ...
                                                        null, 100),
                                        new Product(null, "Leather Tote Bag", "Spacious hand-crafted leather bag.",
                                                        150.00, "Accessories",
                                                        "Bags", "Women", Arrays.asList("One Size"),
                                                        "https://images.unsplash.com/photo-1584917865442-de89df76afd3?q=80&w=1000&auto=format&fit=crop",
                                                        null, 20),
                                        new Product(null, "Classic Chronograph Watch",
                                                        "Sleek stainless steel timepiece.", 199.99,
                                        ...
                                        // Footwear
                                        new Product(null, "Urban Sneakers", "Minimalist white leather sneakers.",
                                                        110.00, "Footwear",
                                                        "Sneakers", "Unisex", Arrays.asList("7", "8", "9", "10", "11"),
                                                        "https://images.unsplash.com/photo-1549298916-b41d501d3772?q=80&w=1000&auto=format&fit=crop",
                                                        null, 60),
                                        new Product(null, "Chelsea Boots", "Genuine suede desert boots.", 140.00,
                                                        "Footwear", "Boots",
                                                        "Men", Arrays.asList("8", "9", "10", "11"),
                                                        "https://images.unsplash.com/photo-1638247025967-b4e38f757b40?q=80&w=1000&auto=format&fit=crop",
                                                        null, 25),
                                        new Product(null, "Stiletto Heels",
                                                        "Timeless black pumps for formal occasions.", 125.00,
                        ...
                        System.out.println(
                                        "Sample products seeded successfully for Men, Women, Accessories, and Footwear.");
                }
        }
}
